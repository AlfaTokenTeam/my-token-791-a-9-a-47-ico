...
import "./MyToken791A9A47.sol";

contract MyToken791A9A47PreSale {
    MyToken791A9A47 public token;
    ...
    function MyToken791A9A47PreSale(
        MyToken791A9A47 _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyToken791A9A47(_token);
